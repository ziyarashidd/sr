...
const Hackathon = () => {
    ...
    return (
        <div className="bg-black text-white font-sans scroll-smooth">
            ...
            {menuOpen && (
                <div className="md:hidden bg-white text-black absolute top-16 left-1/2 transform -translate-x-1/2 w-[90%] rounded-xl p-4 z-40 shadow-lg">
            ...
            {/* Hero Section */}
            <section className="relative h-screen flex flex-col justify-center items-center text-center px-6 md:px-20">
                ...
                <div className="relative z-20 max-w-4xl">
                    ...
                    <p class="mt-3 mb-8 text-sm md:text-base font-semibold text-gray-300">
                        Organised by <span class="text-white font-bold">SR Group of Institutions (SRGI)</span>
                    </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {challenges.map((title, index) => (
            <div key={index} className="bg-gray-800 p-6 rounded-lg shadow hover:shadow-xl transition">
              <h3 className="font-semibold text-lg text-blue-400 mb-2">Problem {index + 1}</h3>
